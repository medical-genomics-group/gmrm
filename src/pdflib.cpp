...
//
{
  ...
  {
    temp = lgamma ( alpha + beta ) - lgamma ( alpha ) - lgamma ( beta );
...
//
{
  ...
  {
    temp = ( alpha - 1.0 ) * log ( rval ) - rval - lgamma ( alpha );
...
//
{
  ...
  else
  {
    ...
    temp1 = temp2 * log ( temp2 ) + temp2 * log ( s ) 
      - ( temp2 * s / rval ) 
      - ( temp2 + 1.0 ) * log ( rval ) - lgamma ( temp2 );
