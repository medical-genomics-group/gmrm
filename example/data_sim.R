...
gri1 <- data.frame("FID" = 0:9999,"chr" = rep(0,10000))
gri2 <- data.frame("FID" = 10000:(M-1),"chr" = rep(1,10000))                  
write.table(gri1,"test_gri1.gri", row.names=FALSE, col.names=FALSE, quote=FALSE)
write.table(gri2,"test_gri2.gri", row.names=FALSE, col.names=FALSE, quote=FALSE)
